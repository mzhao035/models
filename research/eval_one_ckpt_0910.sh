...
DATASET="dataset_wqSfkp"
TRAIN_LOGDIR="/home/zhaomin/Desktop/trifo_models/5vb3c9lk/ckpts/ckpt-57876/"
EVAL_LOGDIR="/home/zhaomin/Desktop/trifo_models/5vb3c9lk/ckpts/ckpt-57876/eval_$DATASET"
echo "${DATASET}"
python "${WORK_DIR}"/eval.py \
  	--eval_logdir="${EVAL_LOGDIR}" \
    --num_classes=16 \
    --dataset="${DATASET}" \
    --dataset_dir="/media/zhaomin/Ruich/000_min_to_move/dataset_v6_update_2020-11-30/$DATASET/tfrecord" \
    --eval_crop_size="241,849" \
