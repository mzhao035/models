...
CKPT_NAME="deeplabv3_mnv2_ade20k_train"
TF_INIT_CKPT="${CKPT_NAME}_2018_12_03.tar.gz"
#cd "${INIT_FOLDER}"
...
#"${INIT_FOLDER}/${CKPT_NAME}model.ckpt-30000" \
#"${CURRENT_DIR}/datasets/Trifo_shoe/exp/train_on_trainval_set_mobilenetv2/train/model.ckpt-0"
