...
TFRECORD_FOR_VIS="/media/zhaomin/ZhaoMin_2T_TOSHIBA EXT/0_Train_data/trifo_2000_traindata/images/180_320/tfrecord"

VIS_CROP_SIZE="193,321"



TRAIN_LOGDIR="/media/zhaomin/ZhaoMin_2T_TOSHIBA EXT/desktop/traintest/train_0720/all_checkpoints/selected_ckpt"
...
VIS_LOGDIR="/media/zhaomin/ZhaoMin_2T_TOSHIBA EXT/desktop/traintest/train_0720/all_checkpoints/vis_result_ckpt_400000"
mkdir -p "${VIS_LOGDIR}"
