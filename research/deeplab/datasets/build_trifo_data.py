...
tf.app.flags.DEFINE_string(
    'output_dir', './ADE20K/ADEChallengeData2016/tfrecord',
  ...
  for shard_id in range(num_shards):
    ...
    with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
      ...
      for i in range(start_idx, end_idx):
        ...
        sys.stdout.flush()
        # Read the image.
        image_filename = valid_img_names[i]
        ...
        example = build_data.image_seg_to_tfexample(
            image_data, valid_img_names[i], height, width, seg_data)
...
#  _convert_dataset('train', FLAGS.train_image_folder, FLAGS.train_image_label_folder,num_shards_train)
  _convert_dataset('val', FLAGS.val_image_folder, FLAGS.val_image_label_folder,num_shards_eval)
